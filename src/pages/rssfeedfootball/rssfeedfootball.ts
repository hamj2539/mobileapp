...
/**
 * Generated class for the RssfeedfootballPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedfootball',
  templateUrl: 'rssfeedfootball.html',
})
export class RssfeedfootballPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssFootball().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
