...
/**
 * Generated class for the RssfeedpoliticsPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedpolitics',
  templateUrl: 'rssfeedpolitics.html',
})
export class RssfeedpoliticsPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssPolitics().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
