...
/**
 * Generated class for the RssfeedtennisPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedtennis',
  templateUrl: 'rssfeedtennis.html',
})
export class RssfeedtennisPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssTennis().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
