...
/**
 * Generated class for the RssfeedgolfPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedgolf',
  templateUrl: 'rssfeedgolf.html',
})
export class RssfeedgolfPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssGolf().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
