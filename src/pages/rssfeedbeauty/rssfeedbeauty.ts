...
/**
 * Generated class for the RssfeedbeautyPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedbeauty',
  templateUrl: 'rssfeedbeauty.html',
})
export class RssfeedbeautyPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssBeauty().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
