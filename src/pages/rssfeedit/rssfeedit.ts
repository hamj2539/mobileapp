...
/**
 * Generated class for the RssfeeditPage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeedit',
  templateUrl: 'rssfeedit.html',
})
export class RssfeeditPage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssNewIT().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
