...
/**
 * Generated class for the RssfeednewgamePage page.
 *
...
@IonicPage()
@Component({
  selector: 'page-rssfeednewgame',
  templateUrl: 'rssfeednewgame.html',
})
export class RssfeednewgamePage {
  rssData: any = [];
  link:string;
  ...
  GetDataRss() {
    this.rssfeed.GetRssNewGame().subscribe(
      data => {
        this.rssData = data;
        console.log(data);
      }
